...
##                temp.wait()
		...
		temp.wait()
		self.log.WriteLog('info',"\n\n@anap.mum1")#'s data not collected because connectivity not available")
		...
		self.copyfiles(self.connect_customer)
        	...
        	cmd =  'tar cvzf pop_%s.tgz ./asn_files/*controller* ./asn_files/*manager*  ./asn_files/*ipsec *' %(self.connect_customer)
